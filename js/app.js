(() => {
    ...
    if (btTheme) btTheme.addEventListener("click", (function(e) {
        btTheme.classList.toggle("_button-theme-active");
        if (bodyTheme) bodyTheme.classList.toggle("_body-theme-active");
    }));
    ...
    function changeTheme(isDarkTheme) {
        const theme = isDarkTheme ? "white" : "default";
    ...
    cards.forEach((card => {
        let buttonOpen = card.querySelector(".product__button");
        let buttonClose = card.querySelector(".button-close-product");
        let add = card.querySelector(".card__add-product");
        buttonOpen.addEventListener("click", (() => {
            add.classList.toggle("_add-product-active");
        }));
        buttonClose.addEventListener("click", (() => {
            add.classList.toggle("_add-product-active");
        }));
    }));
    const favorites = document.querySelectorAll(".button-add-favorites");
